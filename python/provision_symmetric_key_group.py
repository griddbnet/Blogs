...
provisioning_key = os.getenv("PROVISIONING_SYMMETRIC_KEY")
...
device_id_4 = os.getenv("PROVISIONING_DEVICE_ID_4")
device_id_5 = os.getenv("PROVISIONING_DEVICE_ID_5")
device_id_6 = os.getenv("PROVISIONING_DEVICE_ID_6")
device_id_7 = os.getenv("PROVISIONING_DEVICE_ID_7")
device_id_8 = os.getenv("PROVISIONING_DEVICE_ID_8")
device_id_9 = os.getenv("PROVISIONING_DEVICE_ID_9")
device_id_10 = os.getenv("PROVISIONING_DEVICE_ID_10")
...
derived_device_key_1 = derive_device_key(device_id_1, provisioning_key)
derived_device_key_2 = derive_device_key(device_id_2, provisioning_key)
derived_device_key_3 = derive_device_key(device_id_3, provisioning_key)
derived_device_key_4 = derive_device_key(device_id_4, provisioning_key)
derived_device_key_5 = derive_device_key(device_id_5, provisioning_key)
derived_device_key_6 = derive_device_key(device_id_6, provisioning_key)
derived_device_key_7 = derive_device_key(device_id_7, provisioning_key)
derived_device_key_8 = derive_device_key(device_id_8, provisioning_key)
derived_device_key_9 = derive_device_key(device_id_9, provisioning_key)
derived_device_key_10 = derive_device_key(device_id_10, provisioning_key)
...
device_ids_to_keys[device_id_4] = derived_device_key_4
device_ids_to_keys[device_id_5] = derived_device_key_5
device_ids_to_keys[device_id_6] = derived_device_key_6
device_ids_to_keys[device_id_7] = derived_device_key_7
device_ids_to_keys[device_id_8] = derived_device_key_8
device_ids_to_keys[device_id_9] = derived_device_key_9
device_ids_to_keys[device_id_10] = derived_device_key_10
...
async def main():
    ...
    results = await asyncio.gather(
        ...
        register_device(device_id_4),register_device(device_id_5),register_device(device_id_6),
        register_device(device_id_7),register_device(device_id_8),register_device(device_id_9),
        register_device(device_id_10),
    )
