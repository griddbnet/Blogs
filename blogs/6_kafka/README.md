...
$ gs_sh
gs[public]> sql select * from topic_DEVICE7;</code></pre>
</div>
...
<div class="clipboard">
  <pre><code class="language-sh">$ ./bin/kafka-console-consumer.sh --topic device2 --from-beginning --bootstrap-server localhost:9092</code></pre>
</div>
